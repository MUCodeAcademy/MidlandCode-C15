...
When talking about React, it's important to understand how it works. We're not talking about all of the ins and outs on week 1 of React, we're talking broad strokes. One of the most important concepts to understand with React is something called the Virtual DOM.

## Virtual DOM vs Traditional DOM

What we traditionally see in raw javascript is the DOM (Document Object Model). This is what we worked with for the last few weeks and this is the main backbone of web technology for applications in browsers. There are some things to understand about the two first:
...
- Is used with some form of front-end framework/library such as React
- It does not change the UI directly, but it is used to tell the Real DOM which items to re-render and when. So continuing the above example, the steps would look like:
  1. You have a list of 5 items
